...
def vivod():
    ...
    for i in range(len(Name)-1):
        ...
        if int(m)<=int(min(Time1)):
            ...
            waste=str(Name[Time1.index(min(Time1))])+ '  не попало в расписание из-за наложения c другими событиями'+'\n'
    text+='\n'+waste

    messagebox.showinfo("Расписание", text)


text_label=Label(text='Дату и время вводить в формате HH.MM-DD.MM.YYYY\n')
text_label.grid(row=3, column=0,pady=15,columnspan=2)
